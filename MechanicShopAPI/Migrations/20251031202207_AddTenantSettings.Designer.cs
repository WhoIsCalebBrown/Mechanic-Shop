...
namespace MechanicShopAPI.Migrations
{
    ...
    [Migration("20251031202207_AddTenantSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MechanicShopAPI.Models.HolidayOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MechanicShopAPI.Models.NotificationPreferences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AppointmentReminderEmail")
                        .HasColumnType("boolean");

                    b.Property<bool>("AppointmentReminderSms")
                        .HasColumnType("boolean");

                    b.Property<bool>("CancellationEmail")
                        .HasColumnType("boolean");

                    b.Property<bool>("CancellationSms")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("NewBookingEmail")
                        .HasColumnType("boolean");

                    b.Property<bool>("NewBookingSms")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MechanicShopAPI.Models.ServiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "IsBookableOnline");
            ...
            modelBuilder.Entity("MechanicShopAPI.Models.NotificationPreferences", b =>
                {
                    b.HasOne("MechanicShopAPI.Models.Tenant", "Tenant")
                        .WithOne()
                        .HasForeignKey("MechanicShopAPI.Models.NotificationPreferences", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
